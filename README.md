...
- 可复算的大正藏 T01–T55 三十九个固定子集、2,279 条汉译来源逐文件清单；
- 可被下一代维护者接管的开放代码与文档。
...
生产环境设置 `CORPUS_ASSET_BASE_URL=https://canon.foxue.ai` 后读取边缘语料。变量未设置、R2 尚未启用或边缘读取失败时，服务端自动回退到仓库内已核验的 2,511 个完整全文表达或版本见证和 43 个节译、后分、节本、短本、残篇、组件、局部、分离、版本或已知缺文见证，因此经典阅读不依赖单一供应商存活。CBETA 大正藏 T01–T55 三十九个固定来源子集均已逐文件闭合并保留 2,279 个 TEI 来源资产；T54 的 9 份外教资料可检索阅读但明确排除于佛教经典及佛陀亲说覆盖分子，T55 的 42 份经录、请来目录与章疏书目则作为 42 个佛教知识史作品完整保存，但不标成佛陀逐字亲说。T2168A/B 与 T2174A/B 依题名、责任、正文及独立权威入口保持异作；续录、略出、同编者目录和高文本重叠均只形成关系证据。固定 SuttaCentral 提交的 7,288 份巴利 root 已全部受控：经藏 5,764 份与 284,702 个原生稳定段落，律藏 422 份、6 个书级表达与 71,557 个可读稳定段落，论藏 1,102 份、七论书级表达与 88,414 个稳定段落；另有 24 份梵文与俗语 root 按 3 个表达保存。经、律、论、疏、史传、游记、方志、论辩、文书、类书、语文学资料、佛教目录与外教参照文献分别统计，固定来源内 100% 绝不冒充全球佛经作品覆盖率。
