...
- 可复算的大正藏 T01–T54 三十八个固定子集、2,237 条汉译来源逐文件清单；
- 可被下一代维护者接管的开放代码与文档。
...
生产环境设置 `CORPUS_ASSET_BASE_URL=https://canon.foxue.ai` 后读取边缘语料。变量未设置、R2 尚未启用或边缘读取失败时，服务端自动回退到仓库内已核验的 2,469 个完整全文表达或版本见证和 43 个节译、后分、节本、短本、残篇、组件、局部、分离、版本或已知缺文见证，因此经典阅读不依赖单一供应商存活。CBETA 大正藏 T01–T54 三十八个固定来源子集均已逐文件闭合并保留 2,237 个 TEI 来源资产；其中 T54 的 24 份来源按事实建模为 23 个作品和 24 个完整表达，《梵语千字文》A/B 保留为同一作品的两个版本，9 份数论、胜论、道教、摩尼教与景教资料可检索阅读但明确排除于佛教经典及佛陀亲说覆盖分子。T33–T54 的根本经、根本律、根本论、注疏、史传、制度史、语文学资料、佛教类书、外教参照文本、未署名责任、同作品异版、异常残存卷序和跨卷关系均分层建模，不把后世著述或外教文献冒充佛陀亲说，也不因题名、作者、宗师、人物、制度语境、地域、文类、主题、引文或文本重叠误并作品。固定 SuttaCentral 提交的 7,288 份巴利 root 已全部受控：经藏 5,764 份与 284,702 个原生稳定段落，律藏 422 份、6 个书级表达与 71,557 个可读稳定段落，论藏 1,102 份、七论书级表达与 88,414 个稳定段落；另有 24 份梵文与俗语 root 按 3 个表达保存。经、律、论、疏、史传、游记、方志、论辩、文书、类书、语文学资料与外教参照文献分别统计，物理文件、经号、文本表达、版本见证、暂定书目实体、书级集合和规范作品始终分层；固定来源内 100% 绝不冒充全球佛经作品覆盖率。
