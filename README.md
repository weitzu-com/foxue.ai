...
生产环境设置 `CORPUS_ASSET_BASE_URL=https://canon.foxue.ai` 后读取边缘语料。变量未设置、R2 尚未启用或边缘读取失败时，服务端自动回退到仓库内已核验的 940 个完整全文记录和 10 个节译、后分、节本或残篇见证，因此经典阅读不依赖单一供应商存活。CBETA 大正藏 T01–T02 阿含部固定来源记录已逐文件受控（155/155），T03–T04 本缘部完成 72/72，T05–T08 般若部完成 57/57，T09 法华部完成 17/17，T10 华严部完成 31/31，T11 完成 12/12，T12 宝积部末与涅槃部完成 76/76，T13 大集部完成 28/28，T14 经集部完成 166/166，T15 经集部完成 71/71；全站保留 691 个 CBETA TEI 来源资产。《法华经》三种完整汉译与 T0265 节译见证共享规范作品；T0293《四十华严》与 T0294、T0295 两条《入法界品》节译见证共享 Gaṇḍavyūha 规范作品，节译均不计作完整译本。T0315a/T0315b 按同一《普门品经》的两个版本见证登记，T0318/T0319 按同一文殊佛土庄严作品的两个译本登记；T0321–T0354 与 T0310 只建立具体会与合集关系，不冒充整部《大宝积经》的重复译本。T0364 王日休本保留为后世校辑见证；T0374–T0377 分列完整译本、加治本与后分见证；T0388 只作《大云经》文本家族残篇候选，不在证据不足时强行合并。T0397《大方等大集经》按多译者合集见证登记；T0405–T0408、T0410–T0411、T0414–T0415、T0416–T0419、T0420–T0421、T0423–T0424 分别保留同作品异译或异传关系，T0417 明确作为后出节本而不重复计为完整译本。T14 的药师、弥勒、伽耶山顶、维摩诘等 21 个异译组，以及 6 组 a/b 版本见证均保留作品边界；T0469 只作为《文殊师利问经》字母品的部分译出见证，T0451 七佛本愿只与药师经群建立范围关系。T15 的 9 个异译或局部译出组按 DILA 经录和文本范围登记；T0629、T0640 只作局部译出见证，T0606–T0608 与 T0641 在范围未核定前只保留关系，不强并作品，禅观撰述文本也不冒充佛陀亲说。《大般若经》按一个 600 卷文本表达登记并保留 15 个来源资产；《金刚经》六个汉译与《心经》七个长短本分别按同一作品的多个文本表达登记。巴利《法句经》《长部》《中部》《相应部》《增支部》和《小部》共保留 5,764 个 Bilara 经藏来源文件与 284,702 个原生稳定段落标识。这些 100% 都只描述固定来源目录完整性，不是全球佛经作品覆盖率；物理文件、经号、文本表达、版本见证、节译见证、暂定书目实体、书级集合和规范作品始终分层统计。
