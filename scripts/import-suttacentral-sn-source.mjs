...
const batch = JSON.parse(await readFile(resolve(root, "data/corpus/suttacentral/sn-batch-v1.0.0.json"), "utf8"));
...
if (selected.length === 0) {
  console.error("用法：pnpm import:suttacentral:sn --all，或指定 SN1…SN56 / SN1.1 等来源记录");
  process.exit(1);
}
