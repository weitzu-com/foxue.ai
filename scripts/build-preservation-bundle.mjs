...
const requiredPaths = [
  ...
  "data/gbcr/registry-v0.3.0.json",
  "data/gbcr/source-snapshots-v0.2.1.json",
  "data/gbcr/cbeta-taisho-sutra-inventory-v0.2.1.json",
  "data/gbcr/checksums-v0.3.0.sha256",
  "data/corpus/cbeta/NOTICE.md",
  "data/corpus/cbeta/batch-v0.3.0.json",
  "data/corpus/cbeta/catalog-v0.3.0.json",
  "data/corpus/cbeta/manifest-v0.3.0.json",
