...
const inputs = {
  ...
  snapshots: "data/gbcr/source-snapshots-v4.4.0.json",
  ...
  t41Inventory: "data/gbcr/cbeta-taisho-t41-inventory-v0.1.0.json",
  t42Inventory: "data/gbcr/cbeta-taisho-t42-inventory-v0.1.0.json",
  t43Inventory: "data/gbcr/cbeta-taisho-t43-inventory-v0.1.0.json",
  t44Inventory: "data/gbcr/cbeta-taisho-t44-inventory-v0.1.0.json",
  t45Inventory: "data/gbcr/cbeta-taisho-t45-inventory-v0.1.0.json",
  t46Inventory: "data/gbcr/cbeta-taisho-t46-inventory-v0.1.0.json",
  t47Inventory: "data/gbcr/cbeta-taisho-t47-inventory-v0.1.0.json",
  t48Inventory: "data/gbcr/cbeta-taisho-t48-inventory-v0.1.0.json",
  t49Inventory: "data/gbcr/cbeta-taisho-t49-inventory-v0.1.0.json",
  t50Inventory: "data/gbcr/cbeta-taisho-t50-inventory-v0.1.0.json",
  t51Inventory: "data/gbcr/cbeta-taisho-t51-inventory-v0.1.0.json",
  t52Inventory: "data/gbcr/cbeta-taisho-t52-inventory-v0.1.0.json",
  t53Inventory: "data/gbcr/cbeta-taisho-t53-inventory-v0.1.0.json",
  t54Inventory: "data/gbcr/cbeta-taisho-t54-inventory-v0.1.0.json",
  t55Inventory: "data/gbcr/cbeta-taisho-t55-inventory-v0.1.0.json",
  t85Inventory: "data/gbcr/cbeta-taisho-t85-inventory-v0.1.0.json",
  ...
  cbetaT40Batch: "data/corpus/cbeta/batch-v4.7.0.json",
  cbetaT41Batch: "data/corpus/cbeta/batch-v4.8.0.json",
  cbetaT42Batch: "data/corpus/cbeta/batch-v4.9.0.json",
  cbetaT43Batch: "data/corpus/cbeta/batch-v4.10.0.json",
  cbetaT44Batch: "data/corpus/cbeta/batch-v4.11.0.json",
  cbetaT45Batch: "data/corpus/cbeta/batch-v4.12.0.json",
  cbetaT46Batch: "data/corpus/cbeta/batch-v4.13.0.json",
  cbetaT47Batch: "data/corpus/cbeta/batch-v4.14.0.json",
  cbetaT48Batch: "data/corpus/cbeta/batch-v4.15.0.json",
  cbetaT49Batch: "data/corpus/cbeta/batch-v4.16.0.json",
  cbetaT50Batch: "data/corpus/cbeta/batch-v4.17.0.json",
  cbetaT51Batch: "data/corpus/cbeta/batch-v4.18.0.json",
  cbetaT52Batch: "data/corpus/cbeta/batch-v4.19.0.json",
  cbetaT53Batch: "data/corpus/cbeta/batch-v4.20.0.json",
  cbetaT54Batch: "data/corpus/cbeta/batch-v4.21.0.json",
  cbetaT55Batch: "data/corpus/cbeta/batch-v4.22.0.json",
  cbetaBatch: "data/corpus/cbeta/batch-v4.23.0.json",
  cbetaCatalog: "data/corpus/cbeta/catalog-v4.23.0.json",
  cbetaManifest: "data/corpus/cbeta/manifest-v4.23.0.json",
  cbetaRegistry: "data/gbcr/registry-cbeta-v4.23.0.json",
...
const cbetaT40Batch = JSON.parse(rawById.cbetaT40Batch);
const cbetaT41Batch = JSON.parse(rawById.cbetaT41Batch);
const cbetaT42Batch = JSON.parse(rawById.cbetaT42Batch);
const cbetaT43Batch = JSON.parse(rawById.cbetaT43Batch);
const cbetaT44Batch = JSON.parse(rawById.cbetaT44Batch);
const cbetaT45Batch = JSON.parse(rawById.cbetaT45Batch);
const cbetaT46Batch = JSON.parse(rawById.cbetaT46Batch);
const cbetaT47Batch = JSON.parse(rawById.cbetaT47Batch);
const cbetaT48Batch = JSON.parse(rawById.cbetaT48Batch);
const cbetaT49Batch = JSON.parse(rawById.cbetaT49Batch);
const cbetaT50Batch = JSON.parse(rawById.cbetaT50Batch);
const cbetaT51Batch = JSON.parse(rawById.cbetaT51Batch);
const cbetaT52Batch = JSON.parse(rawById.cbetaT52Batch);
const cbetaT53Batch = JSON.parse(rawById.cbetaT53Batch);
const cbetaT54Batch = JSON.parse(rawById.cbetaT54Batch);
const cbetaT55Batch = JSON.parse(rawById.cbetaT55Batch);
...
const outputPath = resolve(root, "data/gbcr/registry-v6.14.0.json");
const checksumPath = resolve(root, "data/gbcr/checksums-v6.14.0.sha256");
const metadataPath = resolve(root, "src/lib/corpus-registry-metadata.ts");
...
if (
  cbetaT36Batch.version !== "4.3.0" || cbetaT36Batch.files.length !== 8 ||
  cbetaT36Batch.collection.sourceRecordDenominator !== 8 ||
  cbetaT36Batch.collection.previouslyControlledSourceRecords !== 0 ||
  cbetaT36Batch.collection.controlledSourceRecords !== 8 ||
  cbetaT36Batch.collection.newSourceBytes !== 14520834 ||
  cbetaT36Batch.collection.newStableSegments !== 91748 ||
  cbetaT36Batch.collection.newFolios !== 3288 ||
  cbetaT36Batch.collection.newJuans !== 140 ||
  cbetaT36Batch.collection.newFullSourceTexts !== 8 ||
  cbetaT36Batch.collection.newPartialSourceWitnesses !== 0 ||
  cbetaT36Batch.collection.verifiedSameWorkExpressions !== 0 ||
  cbetaT36Batch.collection.verifiedPartialWorkWitnesses !== 0 ||
  cbetaT36Batch.collection.verifiedSplitWorkWitnesses !== 0 ||
  cbetaT36Batch.collection.verifiedEditionWitnesses !== 0 ||
  cbetaT36Batch.collection.provisionalRecords !== 0 ||
  cbetaT36Batch.collection.newWorks !== 8
) throw new Error("CBETA T36 固定批次、目录、清单或登记册统计不一致");
if (
  cbetaT37Batch.version !== "4.4.0" || cbetaT37Batch.files.length !== 21 ||
  cbetaT37Batch.collection.sourceRecordDenominator !== 21 ||
  cbetaT37Batch.collection.previouslyControlledSourceRecords !== 0 ||
  cbetaT37Batch.collection.controlledSourceRecords !== 21 ||
  cbetaT37Batch.collection.newSourceBytes !== 10041102 ||
  cbetaT37Batch.collection.newStableSegments !== 77568 ||
  cbetaT37Batch.collection.newFolios !== 2774 ||
  cbetaT37Batch.collection.newJuans !== 117 ||
  cbetaT37Batch.collection.newFullSourceTexts !== 21 ||
  cbetaT37Batch.collection.newPartialSourceWitnesses !== 0 ||
  cbetaT37Batch.collection.verifiedSameWorkExpressions !== 0 ||
  cbetaT37Batch.collection.verifiedPartialWorkWitnesses !== 0 ||
  cbetaT37Batch.collection.verifiedSplitWorkWitnesses !== 0 ||
  cbetaT37Batch.collection.verifiedEditionWitnesses !== 0 ||
  cbetaT37Batch.collection.provisionalRecords !== 0 ||
  cbetaT37Batch.collection.newWorks !== 21
) throw new Error("CBETA T37 固定批次、目录、清单或登记册统计不一致");
if (
  cbetaT38Batch.version !== "4.5.0" || cbetaT38Batch.files.length !== 18 ||
  cbetaT38Batch.collection.sourceRecordDenominator !== 18 ||
  cbetaT38Batch.collection.previouslyControlledSourceRecords !== 0 ||
  cbetaT38Batch.collection.controlledSourceRecords !== 18 ||
  cbetaT38Batch.collection.newSourceBytes !== 13495590 ||
  cbetaT38Batch.collection.newStableSegments !== 95894 ||
  cbetaT38Batch.collection.newFolios !== 3398 ||
  cbetaT38Batch.collection.newJuans !== 108 ||
  cbetaT38Batch.collection.newFullSourceTexts !== 18 ||
  cbetaT38Batch.collection.newPartialSourceWitnesses !== 0 ||
  cbetaT38Batch.collection.verifiedSameWorkExpressions !== 0 ||
  cbetaT38Batch.collection.verifiedPartialWorkWitnesses !== 0 ||
  cbetaT38Batch.collection.verifiedSplitWorkWitnesses !== 0 ||
  cbetaT38Batch.collection.verifiedEditionWitnesses !== 0 ||
  cbetaT38Batch.collection.provisionalRecords !== 0 ||
...
if (
  cbetaT40Batch.version !== "4.7.0" || cbetaT40Batch.files.length !== 17 ||
  cbetaT40Batch.collection.sourceRecordDenominator !== 17 ||
  cbetaT40Batch.collection.previouslyControlledSourceRecords !== 0 ||
  cbetaT40Batch.collection.controlledSourceRecords !== 17 ||
  cbetaT40Batch.collection.newSourceBytes !== 13266426 ||
  cbetaT40Batch.collection.newStableSegments !== 71478 ||
  cbetaT40Batch.collection.newFolios !== 2581 ||
  cbetaT40Batch.collection.newJuans !== 44 ||
  cbetaT40Batch.collection.newFullSourceTexts !== 17 ||
  cbetaT40Batch.collection.newPartialSourceWitnesses !== 0 ||
  cbetaT40Batch.collection.verifiedSameWorkExpressions !== 0 ||
  cbetaT40Batch.collection.verifiedPartialWorkWitnesses !== 0 ||
  cbetaT40Batch.collection.verifiedSplitWorkWitnesses !== 0 ||
  cbetaT40Batch.collection.verifiedEditionWitnesses !== 0 ||
  cbetaT40Batch.collection.provisionalRecords !== 0 ||
  cbetaT40Batch.collection.relationAnnotatedRecords !== 17 ||
  cbetaT40Batch.collection.attributionBoundaryRecords !== 17 ||
  cbetaT40Batch.collection.newWorks !== 17 ||
  cbetaT40Batch.boundaryAudit.status !== "verified_source_integrity_vinaya_root_manual_precept_karman_gender_scope_treatise_commentary_revision_abridgment_supplement_and_subcommentary_boundaries_recorded" ||
  cbetaT40Batch.boundaryAudit.rootVinayaCommentaryGroups.length !== 4 ||
  cbetaT40Batch.boundaryAudit.rootTreatiseCommentaryGroups.length !== 5 ||
  cbetaT40Batch.boundaryAudit.subcommentaryGroups.length !== 1 ||
  cbetaT40Batch.boundaryAudit.scopeBoundaryGroups.length !== 3 ||
  cbetaT40Batch.boundaryAudit.relatedDistinctWorkGroups.length !== 4
) throw new Error("CBETA T40 固定批次、目录、清单或登记册统计不一致");
if (
  cbetaT41Batch.version !== "4.8.0" || cbetaT41Batch.files.length !== 3 ||
  cbetaT41Batch.collection.sourceRecordDenominator !== 3 ||
  cbetaT41Batch.collection.previouslyControlledSourceRecords !== 0 ||
  cbetaT41Batch.collection.controlledSourceRecords !== 3 ||
  cbetaT41Batch.collection.newSourceBytes !== 16077486 ||
  cbetaT41Batch.collection.newStableSegments !== 84212 ||
  cbetaT41Batch.collection.newFolios !== 2999 ||
  cbetaT41Batch.collection.newJuans !== 90 ||
  cbetaT41Batch.collection.newFullSourceTexts !== 3 ||
  cbetaT41Batch.collection.newPartialSourceWitnesses !== 0 ||
  cbetaT41Batch.collection.verifiedSameWorkExpressions !== 0 ||
  cbetaT41Batch.collection.verifiedPartialWorkWitnesses !== 0 ||
  cbetaT41Batch.collection.verifiedSplitWorkWitnesses !== 0 ||
  cbetaT41Batch.collection.verifiedEditionWitnesses !== 0 ||
  cbetaT41Batch.collection.provisionalRecords !== 0 ||
  cbetaT41Batch.collection.relationAnnotatedRecords !== 3 ||
  cbetaT41Batch.collection.attributionBoundaryRecords !== 3 ||
  cbetaT41Batch.collection.newWorks !== 3 ||
  cbetaT41Batch.boundaryAudit.status !== "verified_source_integrity_abhidharmakosa_root_treatise_parallel_commentary_and_verse_commentary_scope_boundaries_recorded" ||
  cbetaT41Batch.boundaryAudit.rootVinayaCommentaryGroups.length !== 0 ||
  cbetaT41Batch.boundaryAudit.rootTreatiseCommentaryGroups.length !== 2 ||
  cbetaT41Batch.boundaryAudit.subcommentaryGroups.length !== 0 ||
  cbetaT41Batch.boundaryAudit.scopeBoundaryGroups.length !== 1 ||
  cbetaT41Batch.boundaryAudit.relatedDistinctWorkGroups.length !== 1
) throw new Error("CBETA T41 固定批次统计不一致");
if (
  cbetaT42Batch.version !== "4.9.0" || cbetaT42Batch.files.length !== 5 ||
  cbetaT42Batch.collection.sourceRecordDenominator !== 5 ||
  cbetaT42Batch.collection.previouslyControlledSourceRecords !== 0 ||
  cbetaT42Batch.collection.controlledSourceRecords !== 5 ||
  cbetaT42Batch.collection.newSourceBytes !== 10207300 ||
  cbetaT42Batch.collection.newStableSegments !== 74641 ||
  cbetaT42Batch.collection.newFolios !== 2613 ||
  cbetaT42Batch.collection.newJuans !== 42 ||
  cbetaT42Batch.collection.newFullSourceTexts !== 5 ||
  cbetaT42Batch.collection.newPartialSourceWitnesses !== 0 ||
  cbetaT42Batch.collection.verifiedSameWorkExpressions !== 0 ||
  cbetaT42Batch.collection.verifiedPartialWorkWitnesses !== 0 ||
  cbetaT42Batch.collection.verifiedSplitWorkWitnesses !== 0 ||
  cbetaT42Batch.collection.verifiedEditionWitnesses !== 0 ||
  cbetaT42Batch.collection.provisionalRecords !== 0 ||
  cbetaT42Batch.collection.relationAnnotatedRecords !== 5 ||
  cbetaT42Batch.collection.attributionBoundaryRecords !== 5 ||
  cbetaT42Batch.collection.newWorks !== 5 ||
  cbetaT42Batch.boundaryAudit.status !== "verified_source_integrity_madhyamaka_and_yogacara_root_treatise_parallel_commentary_and_scope_boundaries_recorded" ||
  cbetaT42Batch.boundaryAudit.rootVinayaCommentaryGroups.length !== 0 ||
  cbetaT42Batch.boundaryAudit.rootTreatiseCommentaryGroups.length !== 4 ||
  cbetaT42Batch.boundaryAudit.subcommentaryGroups.length !== 0 ||
  cbetaT42Batch.boundaryAudit.scopeBoundaryGroups.length !== 1 ||
  cbetaT42Batch.boundaryAudit.relatedDistinctWorkGroups.length !== 2
) throw new Error("CBETA T42 固定批次、目录、清单或登记册统计不一致");
if (
  cbetaT43Batch.version !== "4.10.0" || cbetaT43Batch.files.length !== 6 ||
  cbetaT44Batch.version !== "4.11.0" || cbetaT44Batch.files.length !== 17 ||
  cbetaT44Batch.collection.sourceRecordDenominator !== 17 ||
  cbetaT44Batch.collection.previouslyControlledSourceRecords !== 0 ||
  cbetaT44Batch.collection.controlledSourceRecords !== 17 ||
  cbetaT44Batch.collection.newSourceBytes !== 9429430 ||
  cbetaT44Batch.collection.newStableSegments !== 75170 ||
  cbetaT44Batch.collection.newFolios !== 2663 ||
  cbetaT44Batch.collection.newJuans !== 70 ||
  cbetaT44Batch.collection.newFullSourceTexts !== 17 ||
  cbetaT44Batch.collection.newPartialSourceWitnesses !== 0 ||
  cbetaT44Batch.collection.verifiedSameWorkExpressions !== 0 ||
  cbetaT44Batch.collection.verifiedPartialWorkWitnesses !== 0 ||
  cbetaT44Batch.collection.verifiedSplitWorkWitnesses !== 0 ||
  cbetaT44Batch.collection.verifiedEditionWitnesses !== 0 ||
  cbetaT44Batch.collection.provisionalRecords !== 0 ||
  cbetaT44Batch.collection.relationAnnotatedRecords !== 17 ||
  cbetaT44Batch.collection.attributionBoundaryRecords !== 17 ||
  cbetaT44Batch.collection.newWorks !== 17 ||
  cbetaT44Batch.boundaryAudit.status !== "verified_source_integrity_treatise_logic_awakening_commentary_subcommentary_root_translation_layered_attribution_companion_scope_and_compendium_boundaries_recorded" ||
  cbetaT44Batch.boundaryAudit.rootVinayaCommentaryGroups.length !== 0 ||
  cbetaT44Batch.boundaryAudit.rootTreatiseCommentaryGroups.length !== 7 ||
  cbetaT44Batch.boundaryAudit.rootEditionBoundaryGroups.length !== 2 ||
  cbetaT44Batch.boundaryAudit.subcommentaryGroups.length !== 1 ||
  cbetaT44Batch.boundaryAudit.scopeBoundaryGroups.length !== 3 ||
  cbetaT44Batch.boundaryAudit.relatedDistinctWorkGroups.length !== 6
) throw new Error("CBETA T44 固定批次、目录、清单或登记册统计不一致");
if (
  cbetaT45Batch.version !== "4.12.0" || cbetaT45Batch.files.length !== 61 ||
  cbetaT45Batch.collection.sourceRecordDenominator !== 61 ||
  cbetaT45Batch.collection.previouslyControlledSourceRecords !== 0 ||
  cbetaT45Batch.collection.controlledSourceRecords !== 61 ||
  cbetaT45Batch.collection.newSourceBytes !== 11260895 ||
  cbetaT45Batch.collection.newStableSegments !== 82868 ||
  cbetaT45Batch.collection.newFolios !== 2995 ||
  cbetaT45Batch.collection.newJuans !== 112 ||
  cbetaT45Batch.collection.newFullSourceTexts !== 61 ||
  cbetaT45Batch.collection.newPartialSourceWitnesses !== 0 ||
  cbetaT45Batch.collection.verifiedSameWorkExpressions !== 0 ||
  cbetaT45Batch.collection.verifiedPartialWorkWitnesses !== 0 ||
  cbetaT45Batch.collection.verifiedSplitWorkWitnesses !== 0 ||
  cbetaT45Batch.collection.verifiedEditionWitnesses !== 0 ||
  cbetaT45Batch.collection.provisionalRecords !== 0 ||
  cbetaT45Batch.collection.relationAnnotatedRecords !== 61 ||
  cbetaT45Batch.collection.attributionBoundaryRecords !== 61 ||
  cbetaT45Batch.collection.unsignedResponsibilityRecords !== 3 ||
  cbetaT45Batch.collection.newWorks !== 61 ||
  cbetaT45Batch.boundaryAudit.status !== "verified_source_integrity_east_asian_school_root_commentary_subcommentary_same_number_layered_attribution_vinaya_ritual_and_repentance_boundaries_recorded" ||
  cbetaT45Batch.boundaryAudit.rootVinayaCommentaryGroups.length !== 0 ||
  cbetaT45Batch.boundaryAudit.rootTreatiseCommentaryGroups.length !== 1 ||
  cbetaT45Batch.boundaryAudit.rootEditionBoundaryGroups.length !== 0 ||
  cbetaT45Batch.boundaryAudit.subcommentaryGroups.length !== 1 ||
  cbetaT45Batch.boundaryAudit.sameNumberBoundaryGroups.length !== 2 ||
  cbetaT45Batch.boundaryAudit.layeredAttributionGroups.length !== 5 ||
  cbetaT45Batch.boundaryAudit.scopeBoundaryGroups.length !== 7 ||
  cbetaT45Batch.boundaryAudit.relatedDistinctWorkGroups.length !== 8
) throw new Error("CBETA T45 固定批次、目录、清单或登记册统计不一致");
if (
  cbetaT46Batch.version !== "4.13.0" || cbetaT46Batch.files.length !== 46 ||
  cbetaT46Batch.collection.sourceRecordDenominator !== 46 ||
  cbetaT46Batch.collection.previouslyControlledSourceRecords !== 0 ||
  cbetaT46Batch.collection.controlledSourceRecords !== 46 ||
  cbetaT46Batch.collection.newSourceBytes !== 12140911 ||
  cbetaT46Batch.collection.newStableSegments !== 86123 ||
  cbetaT46Batch.collection.newFolios !== 3099 ||
  cbetaT46Batch.collection.newJuans !== 110 ||
  cbetaT46Batch.collection.newFullSourceTexts !== 46 ||
  cbetaT46Batch.collection.newPartialSourceWitnesses !== 0 ||
  cbetaT46Batch.collection.verifiedSameWorkExpressions !== 0 ||
  cbetaT46Batch.collection.verifiedPartialWorkWitnesses !== 0 ||
  cbetaT46Batch.collection.verifiedSplitWorkWitnesses !== 0 ||
  cbetaT46Batch.collection.verifiedEditionWitnesses !== 0 ||
  cbetaT46Batch.collection.provisionalRecords !== 0 ||
  cbetaT46Batch.collection.relationAnnotatedRecords !== 46 ||
  cbetaT46Batch.collection.attributionBoundaryRecords !== 46 ||
  cbetaT46Batch.collection.unsignedResponsibilityRecords !== 4 ||
  cbetaT46Batch.collection.newWorks !== 46 ||
  cbetaT46Batch.boundaryAudit.status !== "verified_source_integrity_tiantai_root_commentary_same_author_doctrine_history_ritual_unsigned_and_esoteric_boundaries_recorded" ||
  cbetaT46Batch.boundaryAudit.rootVinayaCommentaryGroups.length !== 0 ||
  cbetaT46Batch.boundaryAudit.rootTreatiseCommentaryGroups.length !== 3 ||
  cbetaT46Batch.boundaryAudit.rootEditionBoundaryGroups.length !== 0 ||
  cbetaT46Batch.boundaryAudit.subcommentaryGroups.length !== 0 ||
  cbetaT46Batch.boundaryAudit.sameNumberBoundaryGroups.length !== 0 ||
  cbetaT46Batch.boundaryAudit.layeredAttributionGroups.length !== 2 ||
  cbetaT46Batch.boundaryAudit.scopeBoundaryGroups.length !== 7 ||
  cbetaT46Batch.boundaryAudit.relatedDistinctWorkGroups.length !== 6
) throw new Error("CBETA T46 固定批次统计不一致");
if (
  cbetaT47Batch.version !== "4.14.0" || cbetaT47Batch.files.length !== 49 ||
  cbetaT47Batch.collection.sourceRecordDenominator !== 49 ||
  cbetaT47Batch.collection.previouslyControlledSourceRecords !== 0 ||
  cbetaT47Batch.collection.controlledSourceRecords !== 49 ||
  cbetaT47Batch.collection.newSourceBytes !== 11178014 ||
  cbetaT47Batch.collection.newStableSegments !== 90567 ||
  cbetaT47Batch.collection.newFolios !== 3306 ||
  cbetaT47Batch.collection.newJuans !== 168 ||
  cbetaT47Batch.collection.newFullSourceTexts !== 49 ||
  cbetaT47Batch.collection.newPartialSourceWitnesses !== 0 ||
  cbetaT47Batch.collection.verifiedSameWorkExpressions !== 0 ||
  cbetaT47Batch.collection.verifiedPartialWorkWitnesses !== 0 ||
  cbetaT47Batch.collection.verifiedSplitWorkWitnesses !== 0 ||
  cbetaT47Batch.collection.verifiedEditionWitnesses !== 0 ||
  cbetaT47Batch.collection.provisionalRecords !== 0 ||
  cbetaT47Batch.collection.relationAnnotatedRecords !== 49 ||
  cbetaT47Batch.collection.attributionBoundaryRecords !== 49 ||
  cbetaT47Batch.collection.unsignedResponsibilityRecords !== 1 ||
  cbetaT47Batch.collection.newWorks !== 49 ||
  cbetaT47Batch.boundaryAudit.status !== "verified_source_integrity_pure_land_doctrine_liturgy_same_author_same_number_chan_master_record_and_unsigned_boundaries_recorded" ||
  cbetaT47Batch.boundaryAudit.rootVinayaCommentaryGroups.length !== 0 ||
  cbetaT47Batch.boundaryAudit.rootTreatiseCommentaryGroups.length !== 0 ||
  cbetaT47Batch.boundaryAudit.rootEditionBoundaryGroups.length !== 0 ||
  cbetaT47Batch.boundaryAudit.subcommentaryGroups.length !== 0 ||
  cbetaT47Batch.boundaryAudit.sameNumberBoundaryGroups.length !== 5 ||
  cbetaT47Batch.boundaryAudit.layeredAttributionGroups.length !== 4 ||
  cbetaT47Batch.boundaryAudit.scopeBoundaryGroups.length !== 3 ||
  cbetaT47Batch.boundaryAudit.relatedDistinctWorkGroups.length !== 12
) throw new Error("CBETA T47 固定批次统计不一致");
if (
  cbetaT48Batch.version !== "4.15.0" || cbetaT48Batch.files.length !== 28 ||
  cbetaT48Batch.collection.sourceRecordDenominator !== 28 ||
  cbetaT48Batch.collection.previouslyControlledSourceRecords !== 0 ||
  cbetaT48Batch.collection.controlledSourceRecords !== 28 ||
  cbetaT48Batch.collection.newSourceBytes !== 12935999 ||
  cbetaT48Batch.collection.newStableSegments !== 97956 ||
  cbetaT48Batch.collection.newFolios !== 3593 ||
  cbetaT48Batch.collection.newJuans !== 177 ||
  cbetaT48Batch.collection.newFullSourceTexts !== 28 ||
  cbetaT48Batch.collection.newPartialSourceWitnesses !== 0 ||
  cbetaT48Batch.collection.verifiedSameWorkExpressions !== 0 ||
  cbetaT48Batch.collection.verifiedPartialWorkWitnesses !== 0 ||
  cbetaT48Batch.collection.verifiedSplitWorkWitnesses !== 0 ||
  cbetaT48Batch.collection.verifiedEditionWitnesses !== 0 ||
  cbetaT48Batch.collection.provisionalRecords !== 0 ||
  cbetaT48Batch.collection.relationAnnotatedRecords !== 28 ||
  cbetaT48Batch.collection.attributionBoundaryRecords !== 28 ||
  cbetaT48Batch.collection.unsignedResponsibilityRecords !== 1 ||
  cbetaT48Batch.collection.newWorks !== 28 ||
  cbetaT48Batch.boundaryAudit.status !== "verified_source_integrity_chan_records_koans_platform_sutra_treatises_same_author_same_number_unsigned_and_monastic_rules_boundaries_recorded" ||
  cbetaT48Batch.boundaryAudit.rootVinayaCommentaryGroups.length !== 0 ||
  cbetaT48Batch.boundaryAudit.rootTreatiseCommentaryGroups.length !== 0 ||
  cbetaT48Batch.boundaryAudit.rootEditionBoundaryGroups.length !== 0 ||
  cbetaT48Batch.boundaryAudit.subcommentaryGroups.length !== 0 ||
  cbetaT48Batch.boundaryAudit.sameNumberBoundaryGroups.length !== 3 ||
  cbetaT48Batch.boundaryAudit.layeredAttributionGroups.length !== 3 ||
  cbetaT48Batch.boundaryAudit.scopeBoundaryGroups.length !== 6 ||
  cbetaT48Batch.boundaryAudit.relatedDistinctWorkGroups.length !== 12
) throw new Error("CBETA T48 固定批次统计不一致");
if (
  cbetaT49Batch.version !== "4.16.0" || cbetaT49Batch.files.length !== 14 ||
  cbetaT49Batch.collection.sourceRecordDenominator !== 14 ||
  cbetaT49Batch.collection.previouslyControlledSourceRecords !== 0 ||
  cbetaT49Batch.collection.controlledSourceRecords !== 14 ||
  cbetaT49Batch.collection.newSourceBytes !== 13132361 ||
  cbetaT49Batch.collection.newStableSegments !== 82214 ||
  cbetaT49Batch.collection.newFolios !== 3080 ||
  cbetaT49Batch.collection.newJuans !== 111 ||
  cbetaT49Batch.collection.newFullSourceTexts !== 14 ||
  cbetaT49Batch.collection.newPartialSourceWitnesses !== 0 ||
  cbetaT49Batch.collection.verifiedSameWorkExpressions !== 0 ||
  cbetaT49Batch.collection.verifiedPartialWorkWitnesses !== 0 ||
  cbetaT49Batch.collection.verifiedSplitWorkWitnesses !== 0 ||
  cbetaT49Batch.collection.verifiedEditionWitnesses !== 0 ||
  cbetaT49Batch.collection.provisionalRecords !== 0 ||
  cbetaT49Batch.collection.relationAnnotatedRecords !== 14 ||
  cbetaT49Batch.collection.attributionBoundaryRecords !== 14 ||
  cbetaT49Batch.collection.unsignedResponsibilityRecords !== 0 ||
  cbetaT49Batch.collection.lostTranslatorResponsibilityRecords !== 3 ||
  cbetaT49Batch.collection.newWorks !== 14 ||
  cbetaT49Batch.boundaryAudit.status !== "verified_source_integrity_council_decline_sectarian_treatises_histories_continuation_and_responsibility_boundaries_recorded" ||
  cbetaT49Batch.boundaryAudit.rootVinayaCommentaryGroups.length !== 0 ||
  cbetaT49Batch.boundaryAudit.rootTreatiseCommentaryGroups.length !== 0 ||
  cbetaT49Batch.boundaryAudit.rootEditionBoundaryGroups.length !== 0 ||
  cbetaT49Batch.boundaryAudit.subcommentaryGroups.length !== 0 ||
  cbetaT49Batch.boundaryAudit.sameNumberBoundaryGroups.length !== 0 ||
  cbetaT49Batch.boundaryAudit.layeredAttributionGroups.length !== 2 ||
  cbetaT49Batch.boundaryAudit.scopeBoundaryGroups.length !== 3 ||
  cbetaT49Batch.boundaryAudit.continuationBoundaryGroups.length !== 1 ||
  cbetaT49Batch.boundaryAudit.catalogResponsibilityBoundaryGroups.length !== 1 ||
  cbetaT49Batch.boundaryAudit.relatedDistinctWorkGroups.length !== 7
) throw new Error("CBETA T49 固定批次统计不一致");
if (
  cbetaT50Batch.version !== "4.17.0" || cbetaT50Batch.files.length !== 27 ||
  cbetaT50Batch.collection.sourceRecordDenominator !== 27 ||
  cbetaT50Batch.collection.previouslyControlledSourceRecords !== 0 ||
  cbetaT50Batch.collection.controlledSourceRecords !== 27 ||
  cbetaT50Batch.collection.newSourceBytes !== 19479473 ||
  cbetaT50Batch.collection.newStableSegments !== 87435 ||
  cbetaT50Batch.collection.newFolios !== 3162 ||
  cbetaT50Batch.collection.newJuans !== 152 ||
  cbetaT50Batch.collection.newFullSourceTexts !== 27 ||
  cbetaT50Batch.collection.newPartialSourceWitnesses !== 0 ||
  cbetaT50Batch.collection.verifiedSameWorkExpressions !== 0 ||
  cbetaT50Batch.collection.verifiedPartialWorkWitnesses !== 0 ||
  cbetaT50Batch.collection.verifiedSplitWorkWitnesses !== 0 ||
  cbetaT50Batch.collection.verifiedEditionWitnesses !== 2 ||
  cbetaT50Batch.collection.provisionalRecords !== 0 ||
  cbetaT50Batch.collection.relationAnnotatedRecords !== 27 ||
  cbetaT50Batch.collection.attributionBoundaryRecords !== 27 ||
  cbetaT50Batch.collection.unsignedResponsibilityRecords !== 2 ||
  cbetaT50Batch.collection.lostTranslatorResponsibilityRecords !== 1 ||
  cbetaT50Batch.collection.newWorks !== 26 ||
  cbetaT50Batch.boundaryAudit.status !== "verified_source_integrity_biographical_subject_same_work_edition_responsibility_continuation_gender_regional_and_source_reuse_boundaries_recorded" ||
  cbetaT50Batch.boundaryAudit.rootVinayaCommentaryGroups.length !== 0 ||
  cbetaT50Batch.boundaryAudit.rootTreatiseCommentaryGroups.length !== 0 ||
  cbetaT50Batch.boundaryAudit.rootEditionBoundaryGroups.length !== 1 ||
  cbetaT50Batch.boundaryAudit.editionOrRecensionGroups.length !== 1 ||
  cbetaT50Batch.boundaryAudit.subcommentaryGroups.length !== 0 ||
  cbetaT50Batch.boundaryAudit.sameNumberBoundaryGroups.length !== 1 ||
  cbetaT50Batch.boundaryAudit.layeredAttributionGroups.length !== 2 ||
  cbetaT50Batch.boundaryAudit.scopeBoundaryGroups.length !== 6 ||
  cbetaT50Batch.boundaryAudit.continuationBoundaryGroups.length !== 1 ||
  cbetaT50Batch.boundaryAudit.sourceReuseBoundaryGroups.length !== 2 ||
  cbetaT50Batch.boundaryAudit.relatedDistinctWorkGroups.length !== 9
) throw new Error("CBETA T50 固定批次、目录、清单或登记册统计不一致");
if (
  cbetaT51Batch.version !== "4.18.0" || cbetaT51Batch.files.length !== 36 ||
  cbetaT51Batch.collection.sourceRecordDenominator !== 36 ||
  cbetaT51Batch.collection.previouslyControlledSourceRecords !== 0 ||
  cbetaT51Batch.collection.controlledSourceRecords !== 36 ||
  cbetaT51Batch.collection.newSourceBytes !== 17025589 ||
  cbetaT51Batch.collection.newStableSegments !== 96503 ||
  cbetaT51Batch.collection.newFolios !== 3518 ||
  cbetaT51Batch.collection.newJuans !== 168 ||
  cbetaT51Batch.collection.newFullSourceTexts !== 36 ||
  cbetaT51Batch.collection.newPartialSourceWitnesses !== 0 ||
  cbetaT51Batch.collection.verifiedSameWorkExpressions !== 0 ||
  cbetaT51Batch.collection.verifiedPartialWorkWitnesses !== 0 ||
  cbetaT51Batch.collection.verifiedSplitWorkWitnesses !== 0 ||
  cbetaT51Batch.collection.verifiedEditionWitnesses !== 0 ||
  cbetaT51Batch.collection.provisionalRecords !== 0 ||
  cbetaT51Batch.collection.relationAnnotatedRecords !== 36 ||
  cbetaT51Batch.collection.attributionBoundaryRecords !== 36 ||
  cbetaT51Batch.collection.unsignedResponsibilityRecords !== 5 ||
  cbetaT51Batch.collection.lostTranslatorResponsibilityRecords !== 0 ||
  cbetaT51Batch.collection.newWorks !== 36 ||
  cbetaT51Batch.boundaryAudit.status !== "verified_source_integrity_devotional_lineage_travel_gazetteer_responsibility_continuation_and_source_reuse_boundaries_recorded" ||
  cbetaT51Batch.boundaryAudit.rootVinayaCommentaryGroups.length !== 0 ||
  cbetaT51Batch.boundaryAudit.rootTreatiseCommentaryGroups.length !== 0 ||
  cbetaT51Batch.boundaryAudit.rootEditionBoundaryGroups.length !== 0 ||
  cbetaT51Batch.boundaryAudit.editionOrRecensionGroups.length !== 0 ||
  cbetaT51Batch.boundaryAudit.subcommentaryGroups.length !== 0 ||
  cbetaT51Batch.boundaryAudit.sameNumberBoundaryGroups.length !== 0 ||
  cbetaT51Batch.boundaryAudit.layeredAttributionGroups.length !== 2 ||
  cbetaT51Batch.boundaryAudit.scopeBoundaryGroups.length !== 10 ||
  cbetaT51Batch.boundaryAudit.continuationBoundaryGroups.length !== 2 ||
  cbetaT51Batch.boundaryAudit.sourceReuseBoundaryGroups.length !== 5 ||
  cbetaT51Batch.boundaryAudit.sameAuthorCompanionWorkGroups.length !== 1 ||
  cbetaT51Batch.boundaryAudit.relatedDistinctWorkGroups.length !== 13
) throw new Error("CBETA T51 固定批次、目录、清单或登记册统计不一致");

if (
  cbetaT52Batch.version !== "4.19.0" || cbetaT52Batch.files.length !== 19 ||
  cbetaT52Batch.collection.sourceRecordDenominator !== 19 ||
  cbetaT52Batch.collection.previouslyControlledSourceRecords !== 0 ||
  cbetaT52Batch.collection.controlledSourceRecords !== 19 ||
  cbetaT52Batch.collection.newSourceBytes !== 18836743 ||
  cbetaT52Batch.collection.newStableSegments !== 70393 ||
  cbetaT52Batch.collection.newFolios !== 2654 ||
  cbetaT52Batch.collection.newJuans !== 124 ||
  cbetaT52Batch.collection.newFullSourceTexts !== 19 ||
  cbetaT52Batch.collection.newPartialSourceWitnesses !== 0 ||
  cbetaT52Batch.collection.verifiedSameWorkExpressions !== 0 ||
  cbetaT52Batch.collection.verifiedPartialWorkWitnesses !== 0 ||
  cbetaT52Batch.collection.verifiedSplitWorkWitnesses !== 0 ||
  cbetaT52Batch.collection.verifiedEditionWitnesses !== 0 ||
  cbetaT52Batch.collection.provisionalRecords !== 0 ||
  cbetaT52Batch.collection.relationAnnotatedRecords !== 19 ||
  cbetaT52Batch.collection.attributionBoundaryRecords !== 19 ||
  cbetaT52Batch.collection.unsignedResponsibilityRecords !== 1 ||
  cbetaT52Batch.collection.lostTranslatorResponsibilityRecords !== 0 ||
  cbetaT52Batch.collection.newWorks !== 19 ||
  cbetaT52Batch.boundaryAudit.status !== "verified_source_integrity_apologetic_debate_revelation_memorial_compilation_responsibility_continuation_and_cross_volume_boundaries_recorded" ||
  cbetaT52Batch.boundaryAudit.rootVinayaCommentaryGroups.length !== 0 ||
  cbetaT52Batch.boundaryAudit.rootTreatiseCommentaryGroups.length !== 0 ||
  cbetaT52Batch.boundaryAudit.rootEditionBoundaryGroups.length !== 0 ||
  cbetaT52Batch.boundaryAudit.editionOrRecensionGroups.length !== 0 ||
  cbetaT52Batch.boundaryAudit.subcommentaryGroups.length !== 0 ||
  cbetaT52Batch.boundaryAudit.sameNumberBoundaryGroups.length !== 0 ||
  cbetaT52Batch.boundaryAudit.layeredAttributionGroups.length !== 2 ||
  cbetaT52Batch.boundaryAudit.scopeBoundaryGroups.length !== 2 ||
  cbetaT52Batch.boundaryAudit.continuationBoundaryGroups.length !== 2 ||
  cbetaT52Batch.boundaryAudit.sourceReuseBoundaryGroups.length !== 3 ||
  cbetaT52Batch.boundaryAudit.sameAuthorCompanionWorkGroups.length !== 4 ||
  cbetaT52Batch.boundaryAudit.crossVolumeRelationGroups.length !== 3 ||
  cbetaT52Batch.boundaryAudit.relatedDistinctWorkGroups.length !== 12
) throw new Error("CBETA T52 固定批次、目录、清单或登记册统计不一致");

if (
  cbetaT53Batch.version !== "4.20.0" || cbetaT53Batch.files.length !== 2 ||
  cbetaT53Batch.collection.sourceRecordDenominator !== 2 ||
  cbetaT53Batch.collection.previouslyControlledSourceRecords !== 0 ||
  cbetaT53Batch.collection.controlledSourceRecords !== 2 ||
  cbetaT53Batch.collection.newSourceBytes !== 23150439 ||
  cbetaT53Batch.collection.newStableSegments !== 88027 ||
  cbetaT53Batch.collection.newFolios !== 3178 ||
  cbetaT53Batch.collection.newJuans !== 150 ||
  cbetaT53Batch.collection.newFullSourceTexts !== 2 ||
  cbetaT53Batch.collection.newPartialSourceWitnesses !== 0 ||
  cbetaT53Batch.collection.verifiedSameWorkExpressions !== 0 ||
  cbetaT53Batch.collection.verifiedPartialWorkWitnesses !== 0 ||
  cbetaT53Batch.collection.verifiedSplitWorkWitnesses !== 0 ||
  cbetaT53Batch.collection.verifiedEditionWitnesses !== 0 ||
  cbetaT53Batch.collection.provisionalRecords !== 0 ||
  cbetaT53Batch.collection.relationAnnotatedRecords !== 2 ||
  cbetaT53Batch.collection.attributionBoundaryRecords !== 2 ||
  cbetaT53Batch.collection.unsignedResponsibilityRecords !== 0 ||
  cbetaT53Batch.collection.lostTranslatorResponsibilityRecords !== 0 ||
  cbetaT53Batch.collection.newWorks !== 2 ||
  cbetaT53Batch.boundaryAudit.status !== "verified_source_integrity_encyclopedic_compendium_quotation_reuse_and_layered_responsibility_boundaries_recorded" ||
  cbetaT53Batch.boundaryAudit.rootVinayaCommentaryGroups.length !== 0 ||
  cbetaT53Batch.boundaryAudit.rootTreatiseCommentaryGroups.length !== 0 ||
  cbetaT53Batch.boundaryAudit.rootEditionBoundaryGroups.length !== 0 ||
  cbetaT53Batch.boundaryAudit.editionOrRecensionGroups.length !== 0 ||
  cbetaT53Batch.boundaryAudit.subcommentaryGroups.length !== 0 ||
  cbetaT53Batch.boundaryAudit.sameNumberBoundaryGroups.length !== 0 ||
  cbetaT53Batch.boundaryAudit.layeredAttributionGroups.length !== 2 ||
  cbetaT53Batch.boundaryAudit.scopeBoundaryGroups.length !== 1 ||
  cbetaT53Batch.boundaryAudit.continuationBoundaryGroups.length !== 0 ||
  cbetaT53Batch.boundaryAudit.sourceReuseBoundaryGroups.length !== 1 ||
  cbetaT53Batch.boundaryAudit.sameAuthorCompanionWorkGroups.length !== 0 ||
  cbetaT53Batch.boundaryAudit.crossVolumeRelationGroups.length !== 0 ||
  cbetaT53Batch.boundaryAudit.relatedDistinctWorkGroups.length !== 5
) throw new Error("CBETA T53 固定批次统计不一致");

if (
  cbetaT54Batch.version !== "4.21.0" || cbetaT54Batch.files.length !== 24 ||
  cbetaT54Batch.collection.sourceRecordDenominator !== 24 || cbetaT54Batch.collection.controlledSourceRecords !== 24 ||
  cbetaT54Batch.collection.newSourceBytes !== 25078637 || cbetaT54Batch.collection.newStableSegments !== 91138 ||
  cbetaT54Batch.collection.newFolios !== 3981 || cbetaT54Batch.collection.newJuans !== 176 ||
  cbetaT54Batch.collection.newFullSourceTexts !== 24 || cbetaT54Batch.collection.verifiedEditionWitnesses !== 2 ||
  cbetaT54Batch.collection.newWorks !== 23 || cbetaT54Batch.collection.nonBuddhistReferenceRecords !== 9 ||
  cbetaT54Batch.boundaryAudit.status !== "verified_source_integrity_edition_expansion_language_layered_responsibility_irregular_juan_and_non_buddhist_reference_boundaries_recorded"
) throw new Error("CBETA T54 固定批次统计不一致");

if (
  cbetaT55Batch.version !== "4.22.0" || cbetaT55Batch.files.length !== 42 ||
  cbetaT55Batch.collection.sourceRecordDenominator !== 42 || cbetaT55Batch.collection.controlledSourceRecords !== 42 ||
  cbetaT55Batch.collection.newSourceBytes !== 25586209 || cbetaT55Batch.collection.newStableSegments !== 94016 ||
  cbetaT55Batch.collection.newFolios !== 3631 || cbetaT55Batch.collection.newJuans !== 152 ||
  cbetaT55Batch.collection.newFullSourceTexts !== 42 || cbetaT55Batch.collection.newPartialSourceWitnesses !== 0 ||
  cbetaT55Batch.collection.verifiedEditionWitnesses !== 0 || cbetaT55Batch.collection.newWorks !== 42 ||
  cbetaT55Batch.collection.relationAnnotatedRecords !== 42 || cbetaT55Batch.collection.attributionBoundaryRecords !== 42 ||
  cbetaT55Batch.collection.unsignedResponsibilityRecords !== 3 || cbetaT55Batch.collection.nonBuddhistReferenceRecords !== 0 ||
  cbetaT55Batch.boundaryAudit.status !== "verified_source_integrity_catalogue_succession_same_number_responsibility_and_buddha_word_boundaries_recorded" ||
  cbetaT55Batch.boundaryAudit.sameNumberBoundaryGroups.length !== 2 || cbetaT55Batch.boundaryAudit.scopeBoundaryGroups.length !== 4 ||
  cbetaT55Batch.boundaryAudit.continuationBoundaryGroups.length !== 4 || cbetaT55Batch.boundaryAudit.sourceReuseBoundaryGroups.length !== 3 ||
  cbetaT55Batch.boundaryAudit.sameAuthorCompanionWorkGroups.length !== 2 || cbetaT55Batch.boundaryAudit.relatedDistinctWorkGroups.length !== 14
) throw new Error("CBETA T55 固定批次统计不一致");

if (
  cbetaBatch.version !== "4.23.0" || cbetaBatch.files.length !== 192 ||
  cbetaBatch.collection.sourceRecordDenominator !== 192 || cbetaBatch.collection.controlledSourceRecords !== 192 ||
  cbetaBatch.collection.newSourceBytes !== 15451526 || cbetaBatch.collection.newStableSegments !== 124616 ||
  cbetaBatch.collection.newFolios !== 4529 || cbetaBatch.collection.newJuans !== 221 ||
  cbetaBatch.collection.newFullSourceTexts !== 192 || cbetaBatch.collection.provisionalRecords !== 192 ||
  cbetaBatch.collection.newWorks !== 192 || cbetaBatch.collection.relationAnnotatedRecords !== 192 ||
  cbetaBatch.collection.attributionBoundaryRecords !== 192 || cbetaBatch.collection.unsignedResponsibilityRecords !== 160 ||
  cbetaBatch.collection.buddhistCulturalReferenceRecords !== 7 || cbetaBatch.collection.suspectedTextRecords !== 57 ||
  cbetaBatch.boundaryAudit.status !== "verified_source_integrity_genre_same_number_manuscript_responsibility_suspected_text_and_buddha_word_boundaries_recorded" ||
  cbetaBatch.boundaryAudit.sameNumberBoundaryGroups.length !== 3 || cbetaBatch.boundaryAudit.sameTitleBoundaryGroups.length !== 9 ||
  cbetaBatch.boundaryAudit.irregularJuanSequenceGroups.length !== 4 || cbetaBatch.boundaryAudit.textualComparison.pairs.length !== 17 ||
  cbetaCatalog.files.length !== 2457 || cbetaManifest.files.length !== 2457 ||
  cbetaRegistry.registry.version !== "4.23.0" || cbetaRegistry.works.length !== 2237 ||
  cbetaRegistry.works.flatMap((work) => work.expressions).length !== 2457
) throw new Error("CBETA T85 固定批次、目录、清单或登记册统计不一致");

const cbetaFamily = cbetaRegistry.sourceFamilies.find((family) => family.id === "cbeta_chinese");
if (
  cbetaFamily?.controlledExpressionRecords !== 2471 ||
  cbetaFamily?.controlledExpressionBytes !== 855499447
...
if (
  snapshots.version !== "4.4.0" || snapshots.denominatorReady !== false ||
...
const registry = {
  ...base,
  registry: { ...base.registry, version: "6.14.0", publishedAt: "2026-08-16" },
  sourceFamilies,
  sourceSnapshots,
  ...
  cbetaT36BoundaryAudit: {
    version: cbetaT36Batch.version,
    status: cbetaT36Batch.boundaryAudit.status,
    file: inputs.cbetaT36Batch,
    sha256: sha256(rawById.cbetaT36Batch),
    ...cbetaT36Batch.collection,
    rootTreatiseCommentaryGroups: cbetaT36Batch.boundaryAudit.rootTreatiseCommentaryGroups,
    subcommentaryGroups: cbetaT36Batch.boundaryAudit.subcommentaryGroups,
    relatedDistinctWorkGroups: cbetaT36Batch.boundaryAudit.relatedDistinctWorkGroups,
    candidateRelationsNotMerged: cbetaT36Batch.boundaryAudit.candidateRelationsNotMerged,
    partialWorkWitnesses: cbetaT36Batch.boundaryAudit.partialWorkWitnesses,
    sourceRoles: cbetaT36Batch.boundaryAudit.sourceRoles,
    caveat: cbetaT36Batch.boundaryAudit.caveat,
  },
  cbetaT37BoundaryAudit: {
    version: cbetaT37Batch.version,
    status: cbetaT37Batch.boundaryAudit.status,
    file: inputs.cbetaT37Batch,
    sha256: sha256(rawById.cbetaT37Batch),
    ...cbetaT37Batch.collection,
    rootTreatiseCommentaryGroups: cbetaT37Batch.boundaryAudit.rootTreatiseCommentaryGroups,
    subcommentaryGroups: cbetaT37Batch.boundaryAudit.subcommentaryGroups,
    relatedDistinctWorkGroups: cbetaT37Batch.boundaryAudit.relatedDistinctWorkGroups,
    candidateRelationsNotMerged: cbetaT37Batch.boundaryAudit.candidateRelationsNotMerged,
    partialWorkWitnesses: cbetaT37Batch.boundaryAudit.partialWorkWitnesses,
    sourceRoles: cbetaT37Batch.boundaryAudit.sourceRoles,
    caveat: cbetaT37Batch.boundaryAudit.caveat,
  },
  cbetaT38BoundaryAudit: {
    version: cbetaT38Batch.version,
    status: cbetaT38Batch.boundaryAudit.status,
    file: inputs.cbetaT38Batch,
    sha256: sha256(rawById.cbetaT38Batch),
    ...cbetaT38Batch.collection,
    rootTreatiseCommentaryGroups: cbetaT38Batch.boundaryAudit.rootTreatiseCommentaryGroups,
    subcommentaryGroups: cbetaT38Batch.boundaryAudit.subcommentaryGroups,
    relatedDistinctWorkGroups: cbetaT38Batch.boundaryAudit.relatedDistinctWorkGroups,
    candidateRelationsNotMerged: cbetaT38Batch.boundaryAudit.candidateRelationsNotMerged,
    partialWorkWitnesses: cbetaT38Batch.boundaryAudit.partialWorkWitnesses,
    sourceRoles: cbetaT38Batch.boundaryAudit.sourceRoles,
  ...
  cbetaT40BoundaryAudit: {
    version: cbetaT40Batch.version,
    status: cbetaT40Batch.boundaryAudit.status,
    file: inputs.cbetaT40Batch,
    sha256: sha256(rawById.cbetaT40Batch),
    ...cbetaT40Batch.collection,
    rootVinayaCommentaryGroups: cbetaT40Batch.boundaryAudit.rootVinayaCommentaryGroups,
    rootTreatiseCommentaryGroups: cbetaT40Batch.boundaryAudit.rootTreatiseCommentaryGroups,
    subcommentaryGroups: cbetaT40Batch.boundaryAudit.subcommentaryGroups,
    scopeBoundaryGroups: cbetaT40Batch.boundaryAudit.scopeBoundaryGroups,
    relatedDistinctWorkGroups: cbetaT40Batch.boundaryAudit.relatedDistinctWorkGroups,
    candidateRelationsNotMerged: cbetaT40Batch.boundaryAudit.candidateRelationsNotMerged,
    partialWorkWitnesses: cbetaT40Batch.boundaryAudit.partialWorkWitnesses,
    sourceRoles: cbetaT40Batch.boundaryAudit.sourceRoles,
    caveat: cbetaT40Batch.boundaryAudit.caveat,
  },
  cbetaT41BoundaryAudit: {
    version: cbetaT41Batch.version,
    status: cbetaT41Batch.boundaryAudit.status,
    file: inputs.cbetaT41Batch,
    sha256: sha256(rawById.cbetaT41Batch),
    ...cbetaT41Batch.collection,
    rootVinayaCommentaryGroups: cbetaT41Batch.boundaryAudit.rootVinayaCommentaryGroups,
    rootTreatiseCommentaryGroups: cbetaT41Batch.boundaryAudit.rootTreatiseCommentaryGroups,
    subcommentaryGroups: cbetaT41Batch.boundaryAudit.subcommentaryGroups,
    scopeBoundaryGroups: cbetaT41Batch.boundaryAudit.scopeBoundaryGroups,
    relatedDistinctWorkGroups: cbetaT41Batch.boundaryAudit.relatedDistinctWorkGroups,
    candidateRelationsNotMerged: cbetaT41Batch.boundaryAudit.candidateRelationsNotMerged,
    partialWorkWitnesses: cbetaT41Batch.boundaryAudit.partialWorkWitnesses,
    sourceRoles: cbetaT41Batch.boundaryAudit.sourceRoles,
    caveat: cbetaT41Batch.boundaryAudit.caveat,
  },
  cbetaT42BoundaryAudit: {
    version: cbetaT42Batch.version,
    status: cbetaT42Batch.boundaryAudit.status,
    file: inputs.cbetaT42Batch,
    sha256: sha256(rawById.cbetaT42Batch),
    ...cbetaT42Batch.collection,
    rootVinayaCommentaryGroups: cbetaT42Batch.boundaryAudit.rootVinayaCommentaryGroups,
    rootTreatiseCommentaryGroups: cbetaT42Batch.boundaryAudit.rootTreatiseCommentaryGroups,
    subcommentaryGroups: cbetaT42Batch.boundaryAudit.subcommentaryGroups,
    scopeBoundaryGroups: cbetaT42Batch.boundaryAudit.scopeBoundaryGroups,
    relatedDistinctWorkGroups: cbetaT42Batch.boundaryAudit.relatedDistinctWorkGroups,
    candidateRelationsNotMerged: cbetaT42Batch.boundaryAudit.candidateRelationsNotMerged,
    partialWorkWitnesses: cbetaT42Batch.boundaryAudit.partialWorkWitnesses,
    sourceRoles: cbetaT42Batch.boundaryAudit.sourceRoles,
    caveat: cbetaT42Batch.boundaryAudit.caveat,
  },
  cbetaT43BoundaryAudit: {
    version: cbetaT43Batch.version,
    status: cbetaT43Batch.boundaryAudit.status,
    file: inputs.cbetaT43Batch,
    sha256: sha256(rawById.cbetaT43Batch),
    ...cbetaT43Batch.collection,
    rootVinayaCommentaryGroups: cbetaT43Batch.boundaryAudit.rootVinayaCommentaryGroups,
    rootTreatiseCommentaryGroups: cbetaT43Batch.boundaryAudit.rootTreatiseCommentaryGroups,
    subcommentaryGroups: cbetaT43Batch.boundaryAudit.subcommentaryGroups,
    scopeBoundaryGroups: cbetaT43Batch.boundaryAudit.scopeBoundaryGroups,
    relatedDistinctWorkGroups: cbetaT43Batch.boundaryAudit.relatedDistinctWorkGroups,
    candidateRelationsNotMerged: cbetaT43Batch.boundaryAudit.candidateRelationsNotMerged,
    partialWorkWitnesses: cbetaT43Batch.boundaryAudit.partialWorkWitnesses,
    sourceRoles: cbetaT43Batch.boundaryAudit.sourceRoles,
    caveat: cbetaT43Batch.boundaryAudit.caveat,
  },
  cbetaT44BoundaryAudit: {
    version: cbetaT44Batch.version,
    status: cbetaT44Batch.boundaryAudit.status,
    file: inputs.cbetaT44Batch,
    sha256: sha256(rawById.cbetaT44Batch),
    ...cbetaT44Batch.collection,
    rootVinayaCommentaryGroups: cbetaT44Batch.boundaryAudit.rootVinayaCommentaryGroups,
    rootTreatiseCommentaryGroups: cbetaT44Batch.boundaryAudit.rootTreatiseCommentaryGroups,
    rootEditionBoundaryGroups: cbetaT44Batch.boundaryAudit.rootEditionBoundaryGroups,
    subcommentaryGroups: cbetaT44Batch.boundaryAudit.subcommentaryGroups,
    scopeBoundaryGroups: cbetaT44Batch.boundaryAudit.scopeBoundaryGroups,
    relatedDistinctWorkGroups: cbetaT44Batch.boundaryAudit.relatedDistinctWorkGroups,
    candidateRelationsNotMerged: cbetaT44Batch.boundaryAudit.candidateRelationsNotMerged,
    partialWorkWitnesses: cbetaT44Batch.boundaryAudit.partialWorkWitnesses,
    sourceRoles: cbetaT44Batch.boundaryAudit.sourceRoles,
    caveat: cbetaT44Batch.boundaryAudit.caveat,
  },
  cbetaT45BoundaryAudit: {
    version: cbetaT45Batch.version,
    status: cbetaT45Batch.boundaryAudit.status,
    file: inputs.cbetaT45Batch,
    sha256: sha256(rawById.cbetaT45Batch),
    ...cbetaT45Batch.collection,
    rootVinayaCommentaryGroups: cbetaT45Batch.boundaryAudit.rootVinayaCommentaryGroups,
    rootTreatiseCommentaryGroups: cbetaT45Batch.boundaryAudit.rootTreatiseCommentaryGroups,
    rootEditionBoundaryGroups: cbetaT45Batch.boundaryAudit.rootEditionBoundaryGroups,
    subcommentaryGroups: cbetaT45Batch.boundaryAudit.subcommentaryGroups,
    sameNumberBoundaryGroups: cbetaT45Batch.boundaryAudit.sameNumberBoundaryGroups,
    layeredAttributionGroups: cbetaT45Batch.boundaryAudit.layeredAttributionGroups,
    scopeBoundaryGroups: cbetaT45Batch.boundaryAudit.scopeBoundaryGroups,
    relatedDistinctWorkGroups: cbetaT45Batch.boundaryAudit.relatedDistinctWorkGroups,
    candidateRelationsNotMerged: cbetaT45Batch.boundaryAudit.candidateRelationsNotMerged,
    partialWorkWitnesses: cbetaT45Batch.boundaryAudit.partialWorkWitnesses,
    sourceRoles: cbetaT45Batch.boundaryAudit.sourceRoles,
    caveat: cbetaT45Batch.boundaryAudit.caveat,
  },
  cbetaT46BoundaryAudit: {
    version: cbetaT46Batch.version,
    status: cbetaT46Batch.boundaryAudit.status,
    file: inputs.cbetaT46Batch,
    sha256: sha256(rawById.cbetaT46Batch),
    ...cbetaT46Batch.collection,
    rootVinayaCommentaryGroups: cbetaT46Batch.boundaryAudit.rootVinayaCommentaryGroups,
    rootTreatiseCommentaryGroups: cbetaT46Batch.boundaryAudit.rootTreatiseCommentaryGroups,
    rootEditionBoundaryGroups: cbetaT46Batch.boundaryAudit.rootEditionBoundaryGroups,
    subcommentaryGroups: cbetaT46Batch.boundaryAudit.subcommentaryGroups,
    sameNumberBoundaryGroups: cbetaT46Batch.boundaryAudit.sameNumberBoundaryGroups,
    layeredAttributionGroups: cbetaT46Batch.boundaryAudit.layeredAttributionGroups,
    scopeBoundaryGroups: cbetaT46Batch.boundaryAudit.scopeBoundaryGroups,
    relatedDistinctWorkGroups: cbetaT46Batch.boundaryAudit.relatedDistinctWorkGroups,
    candidateRelationsNotMerged: cbetaT46Batch.boundaryAudit.candidateRelationsNotMerged,
    partialWorkWitnesses: cbetaT46Batch.boundaryAudit.partialWorkWitnesses,
    sourceRoles: cbetaT46Batch.boundaryAudit.sourceRoles,
    caveat: cbetaT46Batch.boundaryAudit.caveat,
  },
  cbetaT47BoundaryAudit: {
    version: cbetaT47Batch.version,
    status: cbetaT47Batch.boundaryAudit.status,
    file: inputs.cbetaT47Batch,
    sha256: sha256(rawById.cbetaT47Batch),
    ...cbetaT47Batch.collection,
    rootVinayaCommentaryGroups: cbetaT47Batch.boundaryAudit.rootVinayaCommentaryGroups,
    rootTreatiseCommentaryGroups: cbetaT47Batch.boundaryAudit.rootTreatiseCommentaryGroups,
    rootEditionBoundaryGroups: cbetaT47Batch.boundaryAudit.rootEditionBoundaryGroups,
    subcommentaryGroups: cbetaT47Batch.boundaryAudit.subcommentaryGroups,
    sameNumberBoundaryGroups: cbetaT47Batch.boundaryAudit.sameNumberBoundaryGroups,
    layeredAttributionGroups: cbetaT47Batch.boundaryAudit.layeredAttributionGroups,
    scopeBoundaryGroups: cbetaT47Batch.boundaryAudit.scopeBoundaryGroups,
    relatedDistinctWorkGroups: cbetaT47Batch.boundaryAudit.relatedDistinctWorkGroups,
    candidateRelationsNotMerged: cbetaT47Batch.boundaryAudit.candidateRelationsNotMerged,
    partialWorkWitnesses: cbetaT47Batch.boundaryAudit.partialWorkWitnesses,
    sourceRoles: cbetaT47Batch.boundaryAudit.sourceRoles,
    caveat: cbetaT47Batch.boundaryAudit.caveat,
  },
  cbetaT48BoundaryAudit: {
    version: cbetaT48Batch.version,
    status: cbetaT48Batch.boundaryAudit.status,
    file: inputs.cbetaT48Batch,
    sha256: sha256(rawById.cbetaT48Batch),
    ...cbetaT48Batch.collection,
    rootVinayaCommentaryGroups: cbetaT48Batch.boundaryAudit.rootVinayaCommentaryGroups,
    rootTreatiseCommentaryGroups: cbetaT48Batch.boundaryAudit.rootTreatiseCommentaryGroups,
    rootEditionBoundaryGroups: cbetaT48Batch.boundaryAudit.rootEditionBoundaryGroups,
    subcommentaryGroups: cbetaT48Batch.boundaryAudit.subcommentaryGroups,
    sameNumberBoundaryGroups: cbetaT48Batch.boundaryAudit.sameNumberBoundaryGroups,
    layeredAttributionGroups: cbetaT48Batch.boundaryAudit.layeredAttributionGroups,
    scopeBoundaryGroups: cbetaT48Batch.boundaryAudit.scopeBoundaryGroups,
    relatedDistinctWorkGroups: cbetaT48Batch.boundaryAudit.relatedDistinctWorkGroups,
    candidateRelationsNotMerged: cbetaT48Batch.boundaryAudit.candidateRelationsNotMerged,
    partialWorkWitnesses: cbetaT48Batch.boundaryAudit.partialWorkWitnesses,
    sourceRoles: cbetaT48Batch.boundaryAudit.sourceRoles,
    caveat: cbetaT48Batch.boundaryAudit.caveat,
  },
  cbetaT49BoundaryAudit: {
    version: cbetaT49Batch.version,
    status: cbetaT49Batch.boundaryAudit.status,
    file: inputs.cbetaT49Batch,
    sha256: sha256(rawById.cbetaT49Batch),
    ...cbetaT49Batch.collection,
    rootVinayaCommentaryGroups: cbetaT49Batch.boundaryAudit.rootVinayaCommentaryGroups,
    rootTreatiseCommentaryGroups: cbetaT49Batch.boundaryAudit.rootTreatiseCommentaryGroups,
    rootEditionBoundaryGroups: cbetaT49Batch.boundaryAudit.rootEditionBoundaryGroups,
    subcommentaryGroups: cbetaT49Batch.boundaryAudit.subcommentaryGroups,
    sameNumberBoundaryGroups: cbetaT49Batch.boundaryAudit.sameNumberBoundaryGroups,
    layeredAttributionGroups: cbetaT49Batch.boundaryAudit.layeredAttributionGroups,
    scopeBoundaryGroups: cbetaT49Batch.boundaryAudit.scopeBoundaryGroups,
    continuationBoundaryGroups: cbetaT49Batch.boundaryAudit.continuationBoundaryGroups,
    catalogResponsibilityBoundaryGroups: cbetaT49Batch.boundaryAudit.catalogResponsibilityBoundaryGroups,
    relatedDistinctWorkGroups: cbetaT49Batch.boundaryAudit.relatedDistinctWorkGroups,
    candidateRelationsNotMerged: cbetaT49Batch.boundaryAudit.candidateRelationsNotMerged,
    partialWorkWitnesses: cbetaT49Batch.boundaryAudit.partialWorkWitnesses,
    sourceRoles: cbetaT49Batch.boundaryAudit.sourceRoles,
    caveat: cbetaT49Batch.boundaryAudit.caveat,
  },
  cbetaT50BoundaryAudit: {
    version: cbetaT50Batch.version,
    status: cbetaT50Batch.boundaryAudit.status,
    file: inputs.cbetaT50Batch,
    sha256: sha256(rawById.cbetaT50Batch),
    ...cbetaT50Batch.collection,
    rootVinayaCommentaryGroups: cbetaT50Batch.boundaryAudit.rootVinayaCommentaryGroups,
    rootTreatiseCommentaryGroups: cbetaT50Batch.boundaryAudit.rootTreatiseCommentaryGroups,
    rootEditionBoundaryGroups: cbetaT50Batch.boundaryAudit.rootEditionBoundaryGroups,
    editionOrRecensionGroups: cbetaT50Batch.boundaryAudit.editionOrRecensionGroups,
    subcommentaryGroups: cbetaT50Batch.boundaryAudit.subcommentaryGroups,
    sameNumberBoundaryGroups: cbetaT50Batch.boundaryAudit.sameNumberBoundaryGroups,
    layeredAttributionGroups: cbetaT50Batch.boundaryAudit.layeredAttributionGroups,
    scopeBoundaryGroups: cbetaT50Batch.boundaryAudit.scopeBoundaryGroups,
    continuationBoundaryGroups: cbetaT50Batch.boundaryAudit.continuationBoundaryGroups,
    sourceReuseBoundaryGroups: cbetaT50Batch.boundaryAudit.sourceReuseBoundaryGroups,
    relatedDistinctWorkGroups: cbetaT50Batch.boundaryAudit.relatedDistinctWorkGroups,
    candidateRelationsNotMerged: cbetaT50Batch.boundaryAudit.candidateRelationsNotMerged,
    partialWorkWitnesses: cbetaT50Batch.boundaryAudit.partialWorkWitnesses,
    editionWitnesses: cbetaT50Batch.boundaryAudit.editionWitnesses,
    sourceRoles: cbetaT50Batch.boundaryAudit.sourceRoles,
    caveat: cbetaT50Batch.boundaryAudit.caveat,
  },
  cbetaT51BoundaryAudit: {
    version: cbetaT51Batch.version,
    status: cbetaT51Batch.boundaryAudit.status,
    file: inputs.cbetaT51Batch,
    sha256: sha256(rawById.cbetaT51Batch),
    ...cbetaT51Batch.collection,
    rootVinayaCommentaryGroups: cbetaT51Batch.boundaryAudit.rootVinayaCommentaryGroups,
    rootTreatiseCommentaryGroups: cbetaT51Batch.boundaryAudit.rootTreatiseCommentaryGroups,
    rootEditionBoundaryGroups: cbetaT51Batch.boundaryAudit.rootEditionBoundaryGroups,
    editionOrRecensionGroups: cbetaT51Batch.boundaryAudit.editionOrRecensionGroups,
    subcommentaryGroups: cbetaT51Batch.boundaryAudit.subcommentaryGroups,
    sameNumberBoundaryGroups: cbetaT51Batch.boundaryAudit.sameNumberBoundaryGroups,
    layeredAttributionGroups: cbetaT51Batch.boundaryAudit.layeredAttributionGroups,
    scopeBoundaryGroups: cbetaT51Batch.boundaryAudit.scopeBoundaryGroups,
    continuationBoundaryGroups: cbetaT51Batch.boundaryAudit.continuationBoundaryGroups,
    sourceReuseBoundaryGroups: cbetaT51Batch.boundaryAudit.sourceReuseBoundaryGroups,
    sameAuthorCompanionWorkGroups: cbetaT51Batch.boundaryAudit.sameAuthorCompanionWorkGroups,
    relatedDistinctWorkGroups: cbetaT51Batch.boundaryAudit.relatedDistinctWorkGroups,
    candidateRelationsNotMerged: cbetaT51Batch.boundaryAudit.candidateRelationsNotMerged,
    partialWorkWitnesses: cbetaT51Batch.boundaryAudit.partialWorkWitnesses,
    editionWitnesses: cbetaT51Batch.boundaryAudit.editionWitnesses,
    sourceRoles: cbetaT51Batch.boundaryAudit.sourceRoles,
    caveat: cbetaT51Batch.boundaryAudit.caveat,
  },
  cbetaT52BoundaryAudit: {
    version: cbetaT52Batch.version,
    status: cbetaT52Batch.boundaryAudit.status,
    file: inputs.cbetaT52Batch,
    sha256: sha256(rawById.cbetaT52Batch),
    ...cbetaT52Batch.collection,
    rootVinayaCommentaryGroups: cbetaT52Batch.boundaryAudit.rootVinayaCommentaryGroups,
    rootTreatiseCommentaryGroups: cbetaT52Batch.boundaryAudit.rootTreatiseCommentaryGroups,
    rootEditionBoundaryGroups: cbetaT52Batch.boundaryAudit.rootEditionBoundaryGroups,
    editionOrRecensionGroups: cbetaT52Batch.boundaryAudit.editionOrRecensionGroups,
    subcommentaryGroups: cbetaT52Batch.boundaryAudit.subcommentaryGroups,
    sameNumberBoundaryGroups: cbetaT52Batch.boundaryAudit.sameNumberBoundaryGroups,
    layeredAttributionGroups: cbetaT52Batch.boundaryAudit.layeredAttributionGroups,
    scopeBoundaryGroups: cbetaT52Batch.boundaryAudit.scopeBoundaryGroups,
    continuationBoundaryGroups: cbetaT52Batch.boundaryAudit.continuationBoundaryGroups,
    sourceReuseBoundaryGroups: cbetaT52Batch.boundaryAudit.sourceReuseBoundaryGroups,
    sameAuthorCompanionWorkGroups: cbetaT52Batch.boundaryAudit.sameAuthorCompanionWorkGroups,
    crossVolumeRelationGroups: cbetaT52Batch.boundaryAudit.crossVolumeRelationGroups,
    relatedDistinctWorkGroups: cbetaT52Batch.boundaryAudit.relatedDistinctWorkGroups,
    candidateRelationsNotMerged: cbetaT52Batch.boundaryAudit.candidateRelationsNotMerged,
    partialWorkWitnesses: cbetaT52Batch.boundaryAudit.partialWorkWitnesses,
    editionWitnesses: cbetaT52Batch.boundaryAudit.editionWitnesses,
    sourceRoles: cbetaT52Batch.boundaryAudit.sourceRoles,
    caveat: cbetaT52Batch.boundaryAudit.caveat,
  },
  cbetaT53BoundaryAudit: {
    version: cbetaT53Batch.version,
    status: cbetaT53Batch.boundaryAudit.status,
    file: inputs.cbetaT53Batch,
    sha256: sha256(rawById.cbetaT53Batch),
    ...cbetaT53Batch.collection,
    rootVinayaCommentaryGroups: cbetaT53Batch.boundaryAudit.rootVinayaCommentaryGroups,
    rootTreatiseCommentaryGroups: cbetaT53Batch.boundaryAudit.rootTreatiseCommentaryGroups,
    rootEditionBoundaryGroups: cbetaT53Batch.boundaryAudit.rootEditionBoundaryGroups,
    editionOrRecensionGroups: cbetaT53Batch.boundaryAudit.editionOrRecensionGroups,
    subcommentaryGroups: cbetaT53Batch.boundaryAudit.subcommentaryGroups,
    sameNumberBoundaryGroups: cbetaT53Batch.boundaryAudit.sameNumberBoundaryGroups,
    layeredAttributionGroups: cbetaT53Batch.boundaryAudit.layeredAttributionGroups,
    scopeBoundaryGroups: cbetaT53Batch.boundaryAudit.scopeBoundaryGroups,
    continuationBoundaryGroups: cbetaT53Batch.boundaryAudit.continuationBoundaryGroups,
    sourceReuseBoundaryGroups: cbetaT53Batch.boundaryAudit.sourceReuseBoundaryGroups,
    sameAuthorCompanionWorkGroups: cbetaT53Batch.boundaryAudit.sameAuthorCompanionWorkGroups,
    crossVolumeRelationGroups: cbetaT53Batch.boundaryAudit.crossVolumeRelationGroups,
    relatedDistinctWorkGroups: cbetaT53Batch.boundaryAudit.relatedDistinctWorkGroups,
    candidateRelationsNotMerged: cbetaT53Batch.boundaryAudit.candidateRelationsNotMerged,
    partialWorkWitnesses: cbetaT53Batch.boundaryAudit.partialWorkWitnesses,
    editionWitnesses: cbetaT53Batch.boundaryAudit.editionWitnesses,
    sourceRoles: cbetaT53Batch.boundaryAudit.sourceRoles,
    caveat: cbetaT53Batch.boundaryAudit.caveat,
  },
  cbetaT54BoundaryAudit: {
    version: cbetaT54Batch.version,
    status: cbetaT54Batch.boundaryAudit.status,
    file: inputs.cbetaT54Batch,
    sha256: sha256(rawById.cbetaT54Batch),
    ...cbetaT54Batch.collection,
    ...Object.fromEntries(["rootVinayaCommentaryGroups", "rootTreatiseCommentaryGroups", "rootEditionBoundaryGroups", "editionOrRecensionGroups", "subcommentaryGroups", "sameNumberBoundaryGroups", "layeredAttributionGroups", "scopeBoundaryGroups", "continuationBoundaryGroups", "sourceReuseBoundaryGroups", "sameAuthorCompanionWorkGroups", "crossVolumeRelationGroups", "irregularJuanSequenceGroups", "nonBuddhistReferenceGroups", "relatedDistinctWorkGroups", "candidateRelationsNotMerged", "partialWorkWitnesses", "editionWitnesses", "sourceRoles", "caveat"].map((key) => [key, cbetaT54Batch.boundaryAudit[key]])),
  },
  cbetaT55BoundaryAudit: {
    version: cbetaT55Batch.version,
    status: cbetaT55Batch.boundaryAudit.status,
    file: inputs.cbetaT55Batch,
    sha256: sha256(rawById.cbetaT55Batch),
    ...cbetaT55Batch.collection,
    ...Object.fromEntries(["rootVinayaCommentaryGroups", "rootTreatiseCommentaryGroups", "rootEditionBoundaryGroups", "editionOrRecensionGroups", "subcommentaryGroups", "sameNumberBoundaryGroups", "layeredAttributionGroups", "scopeBoundaryGroups", "continuationBoundaryGroups", "sourceReuseBoundaryGroups", "sameAuthorCompanionWorkGroups", "crossVolumeRelationGroups", "irregularJuanSequenceGroups", "nonBuddhistReferenceGroups", "relatedDistinctWorkGroups", "candidateRelationsNotMerged", "partialWorkWitnesses", "editionWitnesses", "sourceRoles", "caveat"].map((key) => [key, cbetaT55Batch.boundaryAudit[key]])),
  },
  cbetaT85BoundaryAudit: {
    ...
    ...Object.fromEntries(["rootVinayaCommentaryGroups", "rootTreatiseCommentaryGroups", "rootEditionBoundaryGroups", "editionOrRecensionGroups", "subcommentaryGroups", "sameNumberBoundaryGroups", "sameTitleBoundaryGroups", "layeredAttributionGroups", "scopeBoundaryGroups", "continuationBoundaryGroups", "sourceReuseBoundaryGroups", "sameAuthorCompanionWorkGroups", "crossVolumeRelationGroups", "irregularJuanSequenceGroups", "nonBuddhistReferenceGroups", "manuscriptCollationPendingGroups", "relatedDistinctWorkGroups", "candidateRelationsNotMerged", "partialWorkWitnesses", "editionWitnesses", "sourceRoles", "caveat"].map((key) => [key, cbetaBatch.boundaryAudit[key]])),
  },
  works: [...nonCbetaWorks, ...indicWorks, ...vinayaWorks, ...abhidhammaWorks, ...cbetaWorks],
};
if (
  registry.works.length !== 2526 ||
  registry.works.flatMap((work) => work.expressions).length !== 2746 ||
  registry.works.flatMap((work) => work.expressions).filter((expression) => expression.fullSourceText).length !== 2703 ||
  registry.works.filter((work) => work.expressions.some((expression) => expression.fullSourceText)).length !== 2499 ||
  registry.works.flatMap((work) => work.expressions).reduce((sum, expression) => sum + (expression.stableSegments ?? 0), 0) !== 5159332 ||
  new Set(registry.works.map((work) => work.id)).size !== registry.works.length
) throw new Error("跨语种登记册 v6.14.0 作品或文本表达统计不一致");
const registryRaw = `${JSON.stringify(registry, null, 2)}\n`;
const metadataRaw = `// Generated by scripts/build-federated-corpus.mjs. Do not edit manually.\nexport const CORPUS_REGISTRY_VERSION = ${JSON.stringify(registry.registry.version)} as const;\n`;
const checksumRaw = [
  `${sha256(registryRaw)}  registry-v6.14.0.json`,
  ...entries.slice(1).map(([, relativePath, raw]) => `${sha256(raw)}  ${relativePath.split("/").at(-1)}`),
].join("\n") + "\n";

if (process.argv.includes("--verify")) {
  if (await readFile(outputPath, "utf8") !== registryRaw) throw new Error("registry-v6.14.0.json 不可复现");
  if (await readFile(checksumPath, "utf8") !== checksumRaw) throw new Error("checksums-v6.14.0.sha256 不可复现");
  if (await readFile(metadataPath, "utf8") !== metadataRaw) throw new Error("健康端点登记册版本元数据不可复现");
  console.log("跨语种登记册 v6.14.0 可复现：T85 192/192 固定来源已完成写本、同题、疑似文献与佛说边界审计；全球作品分母保持未知。");
} else {
  ...
  console.log("跨语种登记册 v6.14.0 已生成：T85 新增 192 个暂定作品与 192 个完整来源表达；同题、A/B、残卷、疑似部及佛陀亲说边界保持可审计。");
}
