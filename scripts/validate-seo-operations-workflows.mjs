...
requirePattern(indexNowWorkflow, "IndexNow workflow 必须 checkout 当前部署提交", /ref:\s*\$\{\{\s*github\.sha\s*\}\}/);
...
requirePattern(googleWorkflow, "Google integrations workflow 必须 checkout 当前待验收提交", /ref:\s*\$\{\{\s*github\.sha\s*\}\}/);
