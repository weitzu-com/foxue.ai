...
const manifest = JSON.parse(
  await readFile(resolve(root, "data/corpus/cbeta/manifest-v4.16.0.json"), "utf8"),
);
const registry = JSON.parse(
  await readFile(resolve(root, "data/gbcr/registry-v6.7.0.json"), "utf8"),
);
const catalog = JSON.parse(
  await readFile(resolve(root, "data/corpus/cbeta/catalog-v4.16.0.json"), "utf8"),
);
const errors = [];
