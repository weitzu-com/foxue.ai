...
const manifest = JSON.parse(
  await readFile(resolve(root, "data/corpus/cbeta/manifest-v2.5.0.json"), "utf8"),
);
const registry = JSON.parse(
  await readFile(resolve(root, "data/gbcr/registry-v3.6.0.json"), "utf8"),
);
const catalog = JSON.parse(
  await readFile(resolve(root, "data/corpus/cbeta/catalog-v2.5.0.json"), "utf8"),
);
const errors = [];
