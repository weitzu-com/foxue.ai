...
const registry = {
  ...
  claimPolicy: {
    ...base.claimPolicy,
    reason: "站内登记作品仍为 3,396 部；文本表达增至 3,929 个，其中新增 1 个是已持有巴利《法句》的 1881 年公有领域英语译本。3,377 部既有作品仍在双人复核队列，独立真人决定仍为 0。全球分母与百分比不得发布。",
  },
...
const expected = {
  works: 3396,
  expressions: 3929,
  fullSourceExpressions: 3883,
  worksWithFullSource: 3369,
  stableSegments: 5819230,
};
if (JSON.stringify(totals) !== JSON.stringify(expected)) {
  throw new Error(`GBCR v6.23 统计不一致：${JSON.stringify(totals)} vs ${JSON.stringify(expected)}`);
}
if (
...
const metadataRaw = `// Generated by scripts/build-federated-corpus-v6.23.mjs. Do not edit manually.\nexport const CORPUS_REGISTRY_VERSION = "6.23.0" as const;\n`;
...
if (verifyMode) {
  ...
  console.log("GBCR v6.23 已生成：新增 1 个公版英语法句表达、0 部新作品；独立真人复核仍为 0。");
}
