/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=infra/corpus-edge/wrangler.jsonc infra/corpus-edge/worker-configuration.d.ts` (hash: 8d0f772001926f0000ae4215b898e26f)
// Runtime types generated with workerd@1.20260804.1 2026-08-10 
interface __BaseEnv_Env {
	CORPUS: R2Bucket;
	RELEASE_ID: "gbcr-1.5.0-2b8ab8d5e4fe-eac6c24781dd-5cefe647d041";
}
