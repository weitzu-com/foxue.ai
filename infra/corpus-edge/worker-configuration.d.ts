/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=infra/corpus-edge/wrangler.jsonc infra/corpus-edge/worker-configuration.d.ts` (hash: 3b3d3d76cc028a7bc6389321990b053d)
// Runtime types generated with workerd@1.20260811.1 2026-08-15 nodejs_compat
interface __BaseEnv_Env {
	CORPUS: R2Bucket;
	RELEASE_ID: "__SET_BY_CORPUS_RELEASE_WORKFLOW__";
	RELEASE_MANIFEST_SHA256: "__SET_BY_CORPUS_RELEASE_WORKFLOW__";
