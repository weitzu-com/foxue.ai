/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=infra/corpus-edge/wrangler.jsonc infra/corpus-edge/worker-configuration.d.ts` (hash: e0022b797a0e42c29d4fcd6d4294e495)
// Runtime types generated with workerd@1.20260804.1 2026-08-10 
interface __BaseEnv_Env {
	CORPUS: R2Bucket;
	RELEASE_ID: "gbcr-6.1.0-2b8ab8d5e4fe-eac6c24781dd-a26a837046ff";
}
