/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=infra/corpus-edge/wrangler.jsonc infra/corpus-edge/worker-configuration.d.ts` (hash: 58d37b99b387147b1aac28ad73150693)
// Runtime types generated with workerd@1.20260804.1 2026-08-10 
interface __BaseEnv_Env {
	CORPUS: R2Bucket;
	RELEASE_ID: "gbcr-5.7.0-2b8ab8d5e4fe-eac6c24781dd-d8d66bb9fa2f";
}
