/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=infra/corpus-edge/wrangler.jsonc infra/corpus-edge/worker-configuration.d.ts` (hash: b292d20f08caa79f0f6b3c904666226a)
// Runtime types generated with workerd@1.20260804.1 2026-08-10 
interface __BaseEnv_Env {
	CORPUS: R2Bucket;
	RELEASE_ID: "gbcr-6.13.0-2b8ab8d5e4fe-eac6c24781dd-6329d36fada1";
}
