        ...
        <div className="candidate-cards">
          ...
          <article>
            ...
            <p>
              ...
              T42 中观与瑜伽论疏部固定来源已完成 {snapshot.candidateInventory.chineseT42SourceRecords.controlled}
              /{snapshot.candidateInventory.chineseT42SourceRecords.denominator}（{snapshot.candidateInventory.chineseT42SourceRecords.percentage}%），
              ...
              T47 净土论著、礼赞仪轨与禅宗语录固定来源已完成 {snapshot.candidateInventory.chineseT47SourceRecords.controlled}
              /{snapshot.candidateInventory.chineseT47SourceRecords.denominator}（{snapshot.candidateInventory.chineseT47SourceRecords.percentage}%），
              ...
              T51 求法传、感应传、灯录、游记与佛教方志固定来源已完成 {snapshot.candidateInventory.chineseT51SourceRecords.controlled}
              /{snapshot.candidateInventory.chineseT51SourceRecords.denominator}（{snapshot.candidateInventory.chineseT51SourceRecords.percentage}%），
            ...
            <a
              className="text-link"
              href="https://github.com/weitzu-com/foxue.ai/blob/main/data/gbcr/cbeta-taisho-t42-inventory-v0.1.0.json"
              target="_blank"
              rel="noreferrer"
            >
            ...
            <a
              className="text-link"
              href="https://github.com/weitzu-com/foxue.ai/blob/main/data/gbcr/cbeta-taisho-t47-inventory-v0.1.0.json"
              target="_blank"
              rel="noreferrer"
            >
            ...
            <a
              className="text-link"
              href="https://github.com/weitzu-com/foxue.ai/blob/main/data/gbcr/cbeta-taisho-t51-inventory-v0.1.0.json"
              target="_blank"
              rel="noreferrer"
            >
