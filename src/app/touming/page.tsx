    ...
    <div className="transparency-page page-shell">
      ...
      <section className="known-limits">
        ...
        <div>
          ...
          <h2>当前已知局限</h2>
          <ul>
            <li>经藏现有 {coverage.localHoldings.registeredWorks} 个可追踪作品实体、{coverage.localHoldings.fullSourceTextExpressions} 个完整文本；般若部已核定《金刚经》《心经》的同作品多译本边界，其余经会、文本家族与跨语种候选仍保留待复核状态，尚不能支持全部佛学问答。</li>
