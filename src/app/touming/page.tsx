...
export default function TransparencyPage() {
  ...
  const systems = [
    ...
    { name: "覆盖登记册", status: "公开草案", detail: "GBCR v0.5 · 全球分母尚待审计", icon: Check },
  ...
  return (
    <div className="transparency-page page-shell">
      ...
      <section className="metric-board" aria-label="当前公开数据">
        ...
        <div><span>99% 分母</span><strong>—</strong><small>GBCR v0.5 · 未知</small></div>
      </section>
      ...
      <section className="known-limits">
        ...
        <div>
          ...
          <h2>当前已知局限</h2>
          <ul>
            <li>经藏现有 20 部去重作品、24 个完整文本，仍不能支持全部佛学问答。</li>
            <li>24 个文本均已通过结构与锚点核验，其中 3 部作品完成代表性人工样本复核。</li>
            <li>覆盖登记册已发布 v0.5 草案；汉译候选文本记录可复算，但全球作品分母尚未完成独立审计。</li>
