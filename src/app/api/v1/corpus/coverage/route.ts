  ...
  return Response.json(
    {
      ...
      links: {
        ...
        registry: "https://github.com/weitzu-com/foxue.ai/blob/main/data/gbcr/registry-v3.7.0.json",
        methodology: "https://github.com/weitzu-com/foxue.ai/blob/main/data/gbcr/README.md",
        sourceSnapshot: "https://github.com/weitzu-com/foxue.ai/blob/main/data/gbcr/source-snapshots-v0.7.0.json",
