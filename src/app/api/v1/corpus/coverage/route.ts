  ...
  return Response.json(
    {
      ...
      links: {
        ...
        registry: "https://github.com/weitzu-com/foxue.ai/blob/main/data/gbcr/registry-v4.1.0.json",
        methodology: "https://github.com/weitzu-com/foxue.ai/blob/main/data/gbcr/README.md",
        sourceSnapshot: "https://github.com/weitzu-com/foxue.ai/blob/main/data/gbcr/source-snapshots-v1.1.0.json",
