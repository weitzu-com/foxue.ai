...
const corePages: CorePage[] = [
  ...
  },
  {
    path: "/xue",
    label: "研读",
    summary: "佛经研读中心；先用四步证据读法读懂一段原文，再进入三十段每日原典、经典路径、异译对读、版本校勘与本地研读笺。",
  },
  {
    path: "/xue/xuanjing",
    label: "佛经入门选经",
    summary: "按阅读目的、文本质地与可用时间，在六条已有稳定原文的路径中选择；不提供宗派排行榜或唯一阅读顺序。",
  },
  {
    path: "/xue/dujing",
    label: "佛经证据读法",
    summary: "回答佛经怎么读、读不懂怎么办；用文本身份、上下文、名相与复核边界四步读完一段原文，并分别服务佛教徒、爱好者与研究者。",
  },
  {
    path: "/xue/xinjing/jiaoji",
    label: "心经校记与异读",
    summary: "逐条解码玄奘译 T0251 的 5 组 CBETA 校记与 2 条大正藏原注；每项返回稳定行号、见证符号和固定 TEI 来源。",
  },
  {
    path: "/xue/meiri",
    label: "三十段每日原典",
    summary: "面向佛教徒、佛学爱好者与研究者的月读卷；30 段阿含、般若、法句、净土与法华原文逐段分开静读练习、理解提示和版本核对。",
  },
  {
    path: "/shufang",
    label: "书房",
    summary: "本地私密佛经书房；汇集研读路径、经卷续读位置、稳定原典选文、个人研读笺与研究证据入口，不登录、不上传。",
  },
  {
    path: "/xue/fahuajing",
    label: "法华经七关研读",
    summary: "以鸠摩罗什译 T0262 七处稳定行段进入《法华经》二十八品；分开原句、编辑路标、观照与校读边界，并把 Soothill 1930 节译限制在同品见证。",
  },
  {
    path: "/wenjing",
    label: "问经",
  ...
  },
  {
    ...
    label: "佛经全文逐字检索",
    summary: "在已审计佛典正文中按原句精确检索；高频经句可分批续查，每个命中返回版本、版页、稳定行段和原典链接，不做语义猜测。",
  },
  {
...
- /xue/xuanjing 只在已经开放稳定原文的六条路径之间提供编辑导航；推荐不代表宗派次第、经典高下或个人修行指导
- /xue/dujing 提供文本身份、上下文、名相与复核边界四步证据读法；它是防止误引和版本混淆的阅读工作流，不代表宗派修学次第
- /xue/xinjing/jiaoji 只呈现 T0251 固定 TEI 已编码的 5 组现代校注与 2 条相关原注；采用读法不等于裁定其他传统读法无效
- /xue/meiri 收录 30 段逐字核验原典；编号只帮助读者回来，不代表教义高下、历史次序或连续打卡要求
- /shufang 只从当前浏览器读取续读、选文、研读笺与研究任务状态；个人文字不上送服务器，选文与笔记可分别导出 Markdown
- /yanjiu 只在浏览器本地保存研究问题与判断；导出报告明确区分原典证据和读者结论
- /jingzang/quanwen 覆盖当前经藏发行的完整文本表达与版页；高频经句通过发行绑定游标分批回查候选，忽略空格、标点和大小写，但不自动繁简转换、扩展同义词或把无命中解释为义理不存在
...
- ${absoluteUrl("/shufang")} 汇集当前浏览器中的研读路径、经卷续读位置、原典选文、个人研读笺与研究入口
- 页面只显示本地资产数量和下一步，不把个人问题、笔记正文或阅读轨迹发送到服务器
- 清除网站数据或更换设备会移除本地记录；重要选文与研读笺应先导出开放 Markdown
...
- ${absoluteUrl("/xue/fahuajing")} 从方便品、譬喻品、药草喻品、法师品、从地踊出品、如来寿量品与观世音菩萨普门品进入 T0262
- ${absoluteUrl("/xue/xuanjing")} 按目的、文本质地与可用时间组织六条已有研读路径；不提供唯一阅读顺序，也不代替师承与宗教抉择
- ${absoluteUrl("/xue/dujing")} 用文本身份、上下文、名相与复核边界四步读完一段经文；平台方法不冒充宗派修学次第、师承或学术结论
- ${absoluteUrl("/xue/xinjing/jiaoji")} 逐条呈现 T0251 题署与咒语中的 5 组异读、6 个见证标记和 2 条大正藏原注；它不是七译完整校勘本，也不规定读诵发音
- ${absoluteUrl("/xue/meiri")} 提供 30 段每日原典的静读、理解与版本核对，并逐段返回 CBETA 稳定行号
- 七关引文逐字来自姚秦·鸠摩罗什译稳定行段；完成七关只表示走过入口，不表示已读完二十八品
- 作品页另列 T0263、T0264 两种完整汉译与 T0265 节译见证；共享作品关系不等于品次或句子自动对齐
- Soothill 1930 英译明确删节，每关只链接同品；其来源记录不构成 T0262 的逐句校勘结果
