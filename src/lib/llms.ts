...
const corePages: CorePage[] = [
  ...
  },
  {
    path: "/duidu",
    label: "对读",
    summary: "佛经异译与跨本对读总入口；按佛教徒、爱好者与研究者的任务进入三份已核验书案，并明确同作品、主题相关与逐句对齐的边界。",
  },
  {
...
- /duidu 只汇集已发布且关系已核验的对读书案；书案入口不把相邻位置、相似主题或同作品身份解释为逐句等值
...
- ${absoluteUrl("/duidu")} 是已核验对读书案的统一入口，分别说明全文并排、主题关口与相关段落三种阅读方式
- 总入口只组织已经发布的书案，不自动扩张作品关系，不生产新经文、现代合译或机器逐句对齐
