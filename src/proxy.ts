...
import corpusFolioExistence from "@/data/corpus-folio-existence.generated.json";
...
export function proxy(request: NextRequest) {
  const destinationPath = rewriteCatalogFolioPath(
    request.nextUrl.pathname,
    corpusRuntimeRouting,
    corpusFolioExistence,
  );
